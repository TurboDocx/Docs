...
**Solution:** Add the delegated permissions in the [permissions list below](#required-api-permissions) (at minimum **`User.Read`** under Microsoft Graph, Delegated), then **Grant admin consent** and retry.
