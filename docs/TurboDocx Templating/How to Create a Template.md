...
sidebar_position: 10
description: Create your first TurboDocx template with variable placeholders. Upload Word or Google Docs templates to start automating document generation.
keywords:
  - create template
  - template upload
